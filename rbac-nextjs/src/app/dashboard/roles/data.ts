...
export async function getRolesData() {
  ...
  // Fetch roles with their permissions in a single query, ordered by creation date
  ...
  // Also fetch all permissions separately for the assignment interface, ordered alphabetically
