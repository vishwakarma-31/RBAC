    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 sm:px-6 lg:px-8">
      <Card className="w-full max-w-md p-8 space-y-6">
        <div>
          ...
          <p className="text-center text-gray-600 mt-2">Create admin account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Removed admin verification code for real implementation */
          /* <div>
            <Input
              type="text"
          ...
          <p className="text-sm text-gray-500 mt-1">Admin accounts require special authorization</p>
